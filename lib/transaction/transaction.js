...
Transaction.prototype._getHash = function () {
  ...
  // const buffer = this.version == 10 ? this.newTxid(writer).toBuffer() : this.legacyTxid(writer).toBuffer()
  const buffer =this.newTxid(writer).toBuffer()

  return Hash.sha256sha256(buffer)
}
